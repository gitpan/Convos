...
#     BUILD_REQUIRES => { Test::More=>q[0.90] }
#     CONFIGURE_REQUIRES => {  }
#     EXE_FILES => [q[script/convos]]
#     LICENSE => q[artistic_2]
#     META_MERGE => { resources=>{ homepage=>q[https://github.com/Nordaaker/convos], repository=>q[https://github.com/Nordaaker/convos], bugtracker=>q[https://github.com/Nordaaker/convos/issues], license=>q[http://www.opensource.org/licenses/artistic-license-2.0] } }
#     NAME => q[Convos]
#     PREREQ_PM => { Mojolicious=>q[4.6], Mojo::Redis=>q[0.992], Mojolicious::Plugin::AssetPack=>q[0.06], Mojo::IRC=>q[0.0303], IRC::Utils=>q[0.12], Time::Piece=>q[1.2], Parse::IRC=>q[1.18], Unicode::UTF8=>q[0.58], Test::More=>q[0.90] }
#     TEST_REQUIRES => {  }
...
TO_INST_PM = lib/Convos.pm \
	...
	lib/Convos/public/packed/convos-72719a8f28496bed1402cec0a44f2a14.css \
	lib/Convos/public/packed/convos-7f9f62749d1dcd19d470f032baad5bac.js \
	lib/Convos/public/packed/main-72719a8f28496bed1402cec0a44f2a14.css \
...
PM_TO_BLIB = lib/Convos/templates/event/whois_channels.html.ep \
	...
	lib/Convos/public/packed/main-72719a8f28496bed1402cec0a44f2a14.css \
	blib/lib/Convos/public/packed/main-72719a8f28496bed1402cec0a44f2a14.css \
	lib/Convos/Plugin/Helpers.pm \
	...
	lib/Convos/public/packed/convos-7f9f62749d1dcd19d470f032baad5bac.js \
	blib/lib/Convos/public/packed/convos-7f9f62749d1dcd19d470f032baad5bac.js \
	lib/Convos/templates/oembed/image.html.ep \
	...
	lib/Convos/public/packed/convos-72719a8f28496bed1402cec0a44f2a14.css \
	blib/lib/Convos/public/packed/convos-72719a8f28496bed1402cec0a44f2a14.css \
	lib/Convos/Core/Connection.pm \
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '  Test::More: 0.90' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '  Mojolicious::Plugin::AssetPack: 0.06' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'version: 0.2001' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '            "Test::More" : "0.90"' >> META_new.json
	$(NOECHO) $(ECHO) '         }' >> META_new.json
	$(NOECHO) $(ECHO) '      },' >> META_new.json
	...
	$(NOECHO) $(ECHO) '            "Mojolicious::Plugin::AssetPack" : "0.06",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '      }' >> META_new.json
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "version" : "0.2001"' >> META_new.json
	$(NOECHO) $(ECHO) '}' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <REQUIRE VERSION="0.12" NAME="IRC::Utils" />' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <REQUIRE VERSION="0.58" NAME="Unicode::UTF8" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  ...
	  lib/Convos/public/packed/main-72719a8f28496bed1402cec0a44f2a14.css blib/lib/Convos/public/packed/main-72719a8f28496bed1402cec0a44f2a14.css \
	...
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  ...
	  lib/Convos/public/packed/convos-7f9f62749d1dcd19d470f032baad5bac.js blib/lib/Convos/public/packed/convos-7f9f62749d1dcd19d470f032baad5bac.js \
	  ...
	  lib/Convos/public/packed/convos-72719a8f28496bed1402cec0a44f2a14.css blib/lib/Convos/public/packed/convos-72719a8f28496bed1402cec0a44f2a14.css \
