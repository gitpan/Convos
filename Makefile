...
#     BUILD_REQUIRES => { Mojo::IRC=>q[0.0303], Time::Piece=>q[1.2], Mojolicious=>q[4.6], IRC::Utils=>q[0.12], Parse::IRC=>q[1.18], Mojolicious::Plugin::AssetPack=>q[0.0502], Mojo::Redis=>q[0.992], Unicode::UTF8=>q[0.58] }
#     CONFIGURE_REQUIRES => {  }
#     EXE_FILES => [q[script/convos]]
#     LICENSE => q[artistic_2]
#     META_MERGE => { resources=>{ license=>q[http://www.opensource.org/licenses/artistic-license-2.0], homepage=>q[https://github.com/Nordaaker/convos], bugtracker=>q[https://github.com/Nordaaker/convos/issues], repository=>q[https://github.com/Nordaaker/convos] } }
#     NAME => q[Convos]
#     PREREQ_PM => { Time::Piece=>q[1.2], Mojo::IRC=>q[0.0303], Mojolicious=>q[4.6], IRC::Utils=>q[0.12], Parse::IRC=>q[1.18], Mojolicious::Plugin::AssetPack=>q[0.0502], Mojo::Redis=>q[0.992], Unicode::UTF8=>q[0.58] }
#     TEST_REQUIRES => {  }
...
PM_TO_BLIB = lib/Convos/public/js/ws-reconnecting.js \
	...
	lib/Convos/public/packed/convos-2e92b48dca79894d76c267531c35cd81.js \
	blib/lib/Convos/public/packed/convos-2e92b48dca79894d76c267531c35cd81.js \
	lib/Convos/public/sass/.sass-cache/a951694f82d90dd3c3e0af05ea817ae5f104c7b7/selectize.scssc \
	...
	lib/Convos/public/packed/convos-e83bfb973589982636a43e2c2994c046.css \
	blib/lib/Convos/public/packed/convos-e83bfb973589982636a43e2c2994c046.css \
	lib/Convos/public/js/jquery.hotkeys.min.js \
...
clean :: clean_subdirs
	- $(RM_F) \
	  ...
	  *$(OBJ_EXT) mon.out \
	  ...
	  pm_to_blib.ts core.[0-9] \
	  core.[0-9][0-9] core \
	  perl$(EXE_EXT) MYMETA.yml \
	  core.*perl.*.? tmon.out \
	  so_locations 
	- $(RM_RF) \
	  blib 
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  ...
	  lib/Convos/public/packed/convos-2e92b48dca79894d76c267531c35cd81.js blib/lib/Convos/public/packed/convos-2e92b48dca79894d76c267531c35cd81.js \
	...
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  ...
	  lib/Convos/public/packed/convos-e83bfb973589982636a43e2c2994c046.css blib/lib/Convos/public/packed/convos-e83bfb973589982636a43e2c2994c046.css \
